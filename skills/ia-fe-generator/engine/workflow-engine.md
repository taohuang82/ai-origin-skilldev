...
**只路由**：禁止读 spec/standards、禁止派发 subAgent、禁止写 artifact 正文。要素的执行由 Layer 4 orchestration 派发 element-runner（subAgent 模板）完成，本文件只负责"选中哪个 workflow 并分发给对应 orchestration"。
